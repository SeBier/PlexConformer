...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView_naming = QtWidgets.QTableView(self.tab)
        self.tableView_naming.setObjectName("tableView_naming")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.tableView_naming)
